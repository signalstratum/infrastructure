...
overrides: 'ALL (unless a system message explicitly supersedes)'
machine_parseable: true
high_risk_confidence_threshold: 97
normal_confidence_threshold: 97
additive_floor_confidence_threshold: 92
response_template_required: true
high_risk_categories: 'destructive-edits, irreversible-ops'
---
